...
import './hardGameScreen.css';

type classicHardGameScreenProps = { userName: string; };

export const ClassicHardGameScreen = ({ userName }: classicHardGameScreenProps) => {
    ...
    // Yeni tur başlat (8 gerçek + 1 AI)
    const startNewRound = () => {
        const newImages = getGameImages(8, 1);
        setImages(newImages);
        setShowResult(false);
    ...
    return (
        <div className="classic-easy-game-screen">
            ...
            <div className="game-header">
                <h1>Yapay Görsel Bulma Oyunu - Zor</h1>
            ...
            <div className="hard-images-grid">
                {images.map(image => (
                    <ImageCard
                        key={image.id}
                        imageUrl={image.url}
